...
def calc_similar(vector_i, vector_j, thresh):
    index_i = np.where(vector_i > thresh)[0]
    result = list()
    for vector in vector_j:
        index_j = np.where(vector > thresh)[0]
        diff = np.fabs(np.log(vector_i[index_i]) - np.log(vector[index_j]))
...
if __name__ == '__main__':
    model = '/home/khangtg/Desktop/topicmodel-lib/examples/ap/model-online-ope/object_model.h5'
    database = '/home/khangtg/Desktop/topicmodel-lib/examples/ap/model-online-ope/db.h5'
    vocab_file = '/home/khangtg/tmlib_data/ap_train_raw/vocab.txt'
    data = '/home/khangtg/tmlib_data/ap_train_raw/ap_train_raw.sq' #'/home/khangtg/Desktop/topicmodel-lib/examples/ap/data/ap_train_raw.txt'
